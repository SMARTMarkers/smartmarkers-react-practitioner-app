...
import { getActiveQuestions, getResponse, getAdaptiveResponse } from '../fields/utils'
import {
    ...
    const onNext = async () => {
        if (isAdaptive) {
            if (questionnaireResponse) {
                ...
                const response = await (questionnaire as PromisQuestionnaire).getNextStep(results)
