...
const renderQuestionItem = (item: IQuestionnaireItem, parentProps: BaseFieldProps) => {
...
export const QuestionnaireItemField: React.FC<QuestionnaireItemFieldProps> = props => {
    const { item } = props
